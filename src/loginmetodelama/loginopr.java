 ...
 * @author alwia
 */
public class loginopr extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("W E L C O M E   O P R   ! !");
...
//       }
        ...
        try{
            ...
            String query = "SELECT * FROM `tb_oprlogin` WHERE `username` = '"+txtusername.getText()+"' && `password`= '"+txtpassword.getPassword()+"' ";
    ...
    private void minimizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeMousePressed
        // TODO add your handling code here:
        this.setExtendedState(loginopr.ICONIFIED);
    ...
    private void txtpasswordKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtpasswordKeyPressed
        ...
        try{
            Connection connect = koneksi.getKoneksi();
            Statement sttmnt = connect.createStatement();
            String query = "SELECT * FROM `tb_oprlogin` WHERE `username` = '"+txtusername.getText()+"' && `password`= '"+txtpassword.getText()+"' ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginopr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
