...
public class barangkeluar extends javax.swing.JFrame {
    ...
    public barangkeluar() {
        ...
        tb_barangkeluar.setModel(table);
    ...
    private void tampilData(){
        ...
        int row = tb_barangkeluar.getRowCount();
        for(int a = 0 ; a < row ; a++){
            table.removeRow(0);
        }
    ...
    //menjumlahkan total harga 
        int total = 0;
        for (int i =0; i< tb_barangkeluar.getRowCount(); i++){
               int amount = Integer.parseInt((String)tb_barangkeluar.getValueAt(i,8));
               total += amount;
        }
    ...
    private void cari(){
       ...
       try{
            tb_barangkeluar.setModel(new DefaultTableModel(null, new Object[]{"idtransaksi","idbarang","pembeli","alamat","kontak","namabarang","harga","jumlahbarang","totalharga","tanggaltransaksi"}));
            Connection connect = koneksi.getKoneksi();//memanggil koneksi
            Statement sttmnt = connect.createStatement();//membuat statement
            ResultSet rslt = sttmnt.executeQuery(query);//menjalanakn query
    ...
    private void initComponents() {
        ...
        tb_barangkeluar = new javax.swing.JTable();
        ...
        tb_barangkeluar.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tb_barangkeluar);
    ...
    private void btn_resetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_resetActionPerformed
    	...
    	if (returnValue == JOptionPane.YES_OPTION){
            try{
            String clear = "TRUNCATE `tb_transaksi`";
    ...
    private javax.swing.JTable tb_barangkeluar;
