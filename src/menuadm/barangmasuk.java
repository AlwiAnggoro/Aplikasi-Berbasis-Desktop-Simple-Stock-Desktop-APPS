...
public class barangmasuk extends javax.swing.JFrame {
    ...
    public void showData(String jdate1, String jdate2){
        ...
        try {
            ...
            {
                st = con.prepareStatement("SELECT * FROM `tb_stokbarang` ");
            }else
           {
                st = con.prepareStatement("SELECT * FROM `tb_stokbarang` WHERE `tanggal`BETWEEN '"+jdate1+"' AND '"+jdate2+"'");
    ...
    private void tampilData(){
        ...
        try{
            ...
            while (rslt.next()){
                //menampung data sementara
                    ...
                    String jumlah = rslt.getString("stok1");
                    String harga = rslt.getString("hargaawal");
                    String totalawal = rslt.getString("totalawal");
                    String tanggal = rslt.getString("tanggal");
                    
                //masukan semua data kedalam array
                String[] data = {supplier,idbarang,nama,jumlah,harga,totalawal,tanggal};
        ...
        //menjumlahkan total harga 
            int total = 0;
            for (int i =0; i< tb_barangmasuk.getRowCount(); i++){
                   int amount = Integer.parseInt((String)tb_barangmasuk.getValueAt(i,5));
                   total += amount;
            }
    ...
    private void cari(){
        ...
        String query = "SELECT * FROM `tb_stokbarang` WHERE "
        ...
        try{
            tb_barangmasuk.setModel(new DefaultTableModel(null, new Object[]{"supplier","idbarang","namabarang","stok1","hargaawal","totalawal","tanggal"}));
            Connection connect = koneksi.getKoneksi();//memanggil koneksi
            Statement sttmnt = connect.createStatement();//membuat statement
    ...
    private void initComponents() {
        ...
        tb_barangmasuk = new javax.swing.JTable();
        ...
        jLabel1.setText("B A R A N G    M A S U K");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jDate1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
    ...
    private void btn_printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_printActionPerformed
        ...
        try{
            ...
            String file = "/report/barangmasuk.jasper";
    ...
    private void minimizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeMousePressed
        // TODO add your handling code here:
        this.setExtendedState(barangmasuk.ICONIFIED);
    ...
    private javax.swing.JTable tb_barangmasuk;
